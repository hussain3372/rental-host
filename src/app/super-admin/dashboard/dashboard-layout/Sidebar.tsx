...
export function Sidebar({ onCollapseChange }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div className="flex max-h-[100vh] bg-[#121315] relative">
        ...
        >
          {/* Header */}
          <Link onClick={() => { setIsMobileOpen(false) }} href="/super-admin/dashboard" className="justify-between items-center mb-[48px] flex">
            <Image
      ...
      ${
          ...
          ${
            ...
            <Link
              ...
              className={`flex justify-between items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 ${isActive("/super-admin/dashboard/notifications") ? "bg-[#4a5439]" : "hover:bg-[#4a5439]"
                }`}
            >
              <div className="flex gap-[8px] items-center">
                ...
                <svg
                  ...
                  viewBox="0 0 16 17"
                  fill="none"
                  className={`transition-colors ${isActive("/super-admin/dashboard/notifications")
                ...
                <p
                  className={`font-normal text-[16px] leading-[20px] ${isActive("/super-admin/dashboard/notifications")
                    ? "text-[#eefb75]"
          ...
          <div className="flex-1 ml-[-14px]">
            ...
            <Link
              ...
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive("/super-admin/dashboard") ? "bg-[#4a5439]" : "hover:bg-[#4a5439]"
                }`}
            >
              <div className="relative w-[20px] h-[20px]">
                ...
                <svg
                  ...
                  viewBox="0 0 20 21"
                  fill="none"
                  className={`opacity-100 group-hover:opacity-0 absolute transition-opacity ${isActive("/super-admin/dashboard") ? "hidden" : ""
                    }`}
                >
                  <path
                ...
                <svg
                  ...
                  viewBox="0 0 20 21"
                  fill="none"
                  className={`opacity-0 group-hover:opacity-100 absolute transition-opacity ${isActive("/super-admin/dashboard") ? "opacity-100" : ""
                    }`}
                >
                  <path
                    d="M7.48699 17.3683H4.74533C3.73533 17.3683 2.91699 16.55 2.91699 15.54V10.1616C2.91761 9.76983 3.00194 9.38268 3.16435 9.02611C3.32675 8.66954 3.56347 8.35179 3.85866 8.09414L8.80033 3.78998C9.13309 3.5005 9.55927 3.34106 10.0003 3.34106C10.4414 3.34106 10.8676 3.5005 11.2003 3.78998L16.142 8.09498C16.4371 8.35253 16.6737 8.67014 16.8361 9.02656C16.9985 9.38298 17.0829 9.76997 17.0837 10.1616V15.54C17.0837 16.0247 16.8911 16.4897 16.5484 16.8325C16.2057 17.1754 15.7409 17.3681 15.2562 17.3683H12.742V11.8841C12.742 11.1275 12.1287 10.5133 11.3712 10.5133H8.85866C8.10116 10.5133 7.48783 11.1275 7.48783 11.8841L7.48699 17.3683ZM7.48699 17.3683H12.7428"
              ...
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive("/super-admin/dashboard")
                  ? "text-[#eefb75]"
            ...
            <Link onClick={() => { setIsMobileOpen(false) }}
              ...
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive('/super-admin/dashboard/user-management') || isActive('/super-admin/dashboard/user-management/detail/[id]')
  ...
  >
    ...
    />
              ...
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive('/super-admin/dashboard/user-management')
                  ? 'text-[#eefb75]'
                  : 'text-[#ffffff] group-hover:text-[#eefb75]'
                  } ${isCollapsed ? 'hidden' : 'block'}`}
              >
            ...
            <Link onClick={() => { setIsMobileOpen(false) }}
              ...
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive('/super-admin/dashboard/certificates')
                ? 'bg-[#4a5439]'
                : 'hover:bg-[#4a5439]'
                }`}
            >
...
<path d="M9.58333 18.4825C6.24417 18.4825 4.575 18.4825 3.5375 17.2616C2.5 16.0425 2.5 14.0775 2.5 10.1491C2.5 6.2208 2.5 4.25663 3.5375 3.0358C4.575 1.81496 6.24417 1.8158 9.58333 1.8158C12.9225 1.8158 14.5917 1.8158 15.6292 3.0358C16.4642 4.01913 16.6275 5.4833 16.6592 8.0658M6.66667 6.8158H12.5M6.66667 10.9825H9.16667"  strokeLinecap="round" stroke-linejoin="round"/>
<path d="M16.3415 15.2366C16.822 14.8874 17.1795 14.3951 17.3629 13.8302C17.5463 13.2653 17.5462 12.6568 17.3626 12.092C17.1789 11.5271 16.8212 11.0349 16.3406 10.6859C15.86 10.3369 15.2813 10.149 14.6874 10.1491H14.4782C13.8843 10.1492 13.3057 10.3372 12.8253 10.6863C12.3449 11.0354 11.9873 11.5276 11.8037 12.0924C11.6202 12.6571 11.6201 13.2655 11.8036 13.8304C11.987 14.3952 12.3445 14.8874 12.8249 15.2366M12.8249 15.2366C13.305 15.5867 13.884 15.7749 14.4782 15.7741H14.6865C15.2807 15.7749 15.8598 15.5867 16.3399 15.2366L16.8257 16.7658C17.0107 17.3491 17.104 17.6408 17.0782 17.8224C17.0257 18.2008 16.7174 18.4808 16.3532 18.4824C16.1782 18.4824 15.9165 18.3458 15.3924 18.0708C15.1674 17.9524 15.0557 17.8941 14.9407 17.8591C14.7069 17.7892 14.4578 17.7892 14.224 17.8591C14.109 17.8941 13.9965 17.9524 13.7724 18.0708C13.2482 18.3458 12.9865 18.4833 12.8115 18.4824C12.4474 18.4808 12.139 18.2008 12.0865 17.8224C12.0615 17.6408 12.1532 17.3491 12.339 16.7658L12.8249 15.2366Z"/>
              ...
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive('/super-admin/dashboard/certificates')
                  ? 'text-[#eefb75]'
                  : 'text-[#ffffff] group-hover:text-[#eefb75]'
                  } ${isCollapsed ? 'hidden' : 'block'}`}
              >
            ...
            <Link onClick={() => { setIsMobileOpen(false) }}
              href="/super-admin/dashboard/coming-soon"
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive('/super-admin/dashboard/coming-soon')
                ? 'bg-[#4a5439]'
                : 'hover:bg-[#4a5439]'
                }`}
            >
              <div className="relative w-[20px] h-[20px] group">
                <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg" className={`${
      isActive("/super-admin/dashboard/coming-soon") 
        ? "stroke-[#EFFC76]" 
        : "stroke-white group-hover:stroke-[#EFFC76]"
    }`}>
...
<path d="M9.99961 13.7331C10.7731 13.7331 11.3996 13.2109 11.3996 12.5669C11.3996 11.9229 10.7731 11.4 9.99961 11.4C9.22611 11.4 8.59961 10.8778 8.59961 10.2331C8.59961 9.58914 9.22611 9.06694 9.99961 9.06694M9.99961 13.7331C9.22611 13.7331 8.59961 13.2109 8.59961 12.5669M9.99961 13.7331V14.2M9.99961 9.06694V8.60004M9.99961 9.06694C10.7731 9.06694 11.3996 9.58914 11.3996 10.2331" strokeLinecap="round"/>
            ...
            <Link onClick={() => { setIsMobileOpen(false) }}
              ...
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive('/super-admin/dashboard/reports')
                ? 'bg-[#4a5439]'
                : 'hover:bg-[#4a5439]'
                }`}
            >
  ...
  >
    ...
    />
              ...
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive('/super-admin/dashboard/reports')
                  ? 'text-[#eefb75]'
                  : 'text-[#ffffff] group-hover:text-[#eefb75]'
                  } ${isCollapsed ? 'hidden' : 'block'}`}
              >
          ...
          <div className="pb-[24px] ml-[-14px]">
            ...
            <Link
              ...
              className={`flex gap-[8px] items-center group px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive("/super-admin/dashboard/subscription-plan")
                ? "bg-[#4a5439]"
                : "hover:bg-[#4a5439]"
                }`}
            >
              ...
              <svg
                ...
                viewBox="0 0 20 20"
                fill="none"
                className={`opacity-100 group-hover:hidden ${isActive("/super-admin/dashboard/subscription-plan") ? "hidden" : "block"
                  }`}
              >
                <path
              ...
              <svg
                ...
                viewBox="0 0 20 20"
                fill="none"
                className={`${isActive("/super-admin/dashboard/subscription-plan")
                  ? "block opacity-100"
              ...
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive("/super-admin/dashboard/subscription-plan")
                  ? "text-[#eefb75]"
                  : "text-[#ffffff] group-hover:text-[#eefb75]"
                  } ${isCollapsed ? "hidden" : "block"}`}
              >
            ...
            <Link
              ...
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive("/super-admin/dashboard/help-support")
                ? "bg-[#4a5439]"
                : "hover:bg-[#4a5439]"
                }`}
            >
              <svg
                ...
                viewBox="0 0 20 20"
                fill="none"
                className={`${isActive("/super-admin/dashboard/help-support") ? "hidden" : "block group-hover:hidden"}`}
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
              ...
              <svg
                ...
                viewBox="0 0 20 20"
                fill="none"
                className={`${isActive("/super-admin/dashboard/help-support") ? "block" : "hidden group-hover:block"}`}
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
              ...
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive("/super-admin/dashboard/help-support")
                  ? "text-[#eefb75]"
                  : "text-[#ffffff] group-hover:text-[#eefb75]"
                  } ${isCollapsed ? "hidden" : "block"}`}
              >

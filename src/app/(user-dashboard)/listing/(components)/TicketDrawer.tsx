            ...
            <div className="space-y-5">
                ...
                <div className="relative">
                    ...
                    <select
                        ...
                        className={` ${!issueType ? "text-white/40":"text-white"} w-full appearance-none p-3 rounded-[10px] cursor-pointer focus:outline-none bg-[radial-gradient(75%_81%_at_50%_18.4%,_#202020_0%,_#101010_100%)] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.1)]`}
                    >
                        <option className="bg-[#202020]" value="" disabled>Select type</option>
                        <option className="bg-[#202020] cursor-pointer" value="account">Account Issue</option>
                        <option className="bg-[#202020] cursor-pointer" value="payment">Payment Problem</option>
                        <option className="bg-[#202020] cursor-pointer" value="bug">Report a Bug</option>
                        <option className="bg-[#202020] cursor-pointer" value="other">Other</option>
                    </select>
                    <Image src="/images/dropdown.svg" width={20} height={20} alt="dropdown" className="absolute top-12 right-6" />
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full p-3 rounded-[10px] placeholder:text-white/40 focus:outline-none bg-[radial-gradient(75%_81%_at_50%_18.4%,_#202020_0%,_#101010_100%)] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.1)]"
                    />
                </div>
                ...
                <div className="mb-10">
                    ...
                    <input
                        ...
                        className="w-full p-3 focus:outline-none placeholder:text-white/40 rounded-[10px] bg-[radial-gradient(75%_81%_at_50%_18.4%,_#202020_0%,_#101010_100%)] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.1)]"
                    />
                </div>

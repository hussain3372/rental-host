...
export default function Plans() {
  ...
  return (
    <div className=' max-w-[1440px] pb-[20px] sm:pb-[96px] mx-auto px-3 md:px-[80px] lg:px-[120px] pt-[10px] md:pt-[96px] '>
      <div className=''>
        <BlackButton
            text="Our plans"
          ...
          />
          <h2 className='max-w-[695px] font-medium text-[30px] md:text-[48px] leading-[40px] md:leading-[56px] text-[#FFFFFF] py-[10px] md:py-[24px]'>Flexible hosting plans that grow with your property needs</h2>
          <p className="font-medium max-w-[600px] text-[18px] leading-[22px] text-[#FFFFFF99]">
            Choose the plan that fits your hosting needs and grow at your own pace with flexible options designed for every property owner.
          </p>
          <div className='flex gap-[12px] items-center pt-[67px]'>
            <p className={`${ isOn ? "text-[#999999]":"text-white" } font-medium text-[12px] sm:text-[16px] leading-[22px] sm:leading-[24px]`}>Monthly</p>
            <ToggleSwitch
            isOn={isOn}
            onToggle={handleToggle}/>
            <p className={`${isOn ? "text-white" : "text-[#999999]"} text-[12px] sm:text-[16px] leading-[22px] sm:leading-[24px]`}>Yearly</p>
            <div className='bg-[#2D2D2D] rounded-full py-[6px] px-[8px] '>
            <p className='text-[#EFFC76] font-semibold text-[12px] leading-[14px]'>Save 20%</p>
            </div>
          </div>
      </div>

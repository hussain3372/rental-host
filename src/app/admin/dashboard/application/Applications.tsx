...
export default function Applications() {
  ...
  const handleDeleteSingleApplication = (row: TableRowData) => {
    const itemToDelete = filteredCertificationData.find(item => 
  ...
  const handleRowClick = (row: TableRowData) => {
    ...
    const applicationId = encodeURIComponent(row["Application Id"]);
    router.push(`/dashboard/application/detail/${applicationId}`);
  };

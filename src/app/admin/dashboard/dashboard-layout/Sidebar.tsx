      ...
      ${
            ...
            >
              <div className="flex gap-[8px] items-center">
                ...
                <svg
                  ...
                  viewBox="0 0 16 17"
                  fill="none"
                  className={`transition-colors ${isActive("/admin/dashboard/notifications")
          ...
          <div className="flex-1 ml-[-14px]">
            ...
            <Link
              ...
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive("/admin/dashboard") ? "bg-[#4a5439]" : "hover:bg-[#4a5439]"
                }`}
            >
              <div className="relative w-[20px] h-[20px]">
                ...
                <svg
                  ...
                  viewBox="0 0 20 21"
                  fill="none"
                  className={`opacity-100 group-hover:opacity-0 absolute transition-opacity ${isActive("/admin/dashboard") ? "hidden" : ""
                    }`}
                >
                  <path
          ...
          <div className="pb-[24px] ml-[-14px]">
            ...
            >
              ...
              <svg
                ...
                viewBox="0 0 20 20"
                fill="none"
                className={`opacity-100 group-hover:hidden ${isActive("/admin/dashboard/subscription-plan") ? "hidden" : "block"
                  }`}
              >
                <path
              ...
              <svg
                ...
                viewBox="0 0 20 20"
                fill="none"
                className={`${isActive("/admin/dashboard/subscription-plan")
                  ? "block opacity-100"
              ...
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive("/admin/dashboard/subscription-plan")
                  ? "text-[#eefb75]"
                  : "text-[#ffffff] group-hover:text-[#eefb75]"
                  } ${isCollapsed ? "hidden" : "block"}`}
              >
            ...
            <Link
              ...
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive("/admin/dashboard/help-support")
                ? "bg-[#4a5439]"
                : "hover:bg-[#4a5439]"
                }`}
            >
              <svg
                ...
                viewBox="0 0 20 20"
                fill="none"
                className={`${isActive("/admin/dashboard/help-support") ? "hidden" : "block group-hover:hidden"}`}
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
              ...
              <svg
                ...
                viewBox="0 0 20 20"
                fill="none"
                className={`${isActive("/admin/dashboard/help-support") ? "block" : "hidden group-hover:block"}`}
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
              ...
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive("/admin/dashboard/help-support")
                  ? "text-[#eefb75]"
                  : "text-[#ffffff] group-hover:text-[#eefb75]"
                  } ${isCollapsed ? "hidden" : "block"}`}
              >

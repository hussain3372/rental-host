  ...
  return (
    <>
      ...
      <div className="flex max-h-[100vh] bg-[#121315] relative">
        ...
        >
          {/* Header */}
          <Link onClick={() => { setIsMobileOpen(false) }} href="/admin/dashboard" className="justify-between items-center mb-[48px] flex">
            <Image
        ...
        ""
          ...
          ${
            ...
            <Link onClick={() => { setIsMobileOpen(false) }}
              ...
              className={`flex justify-between items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 ${isActive('/admin/dashboard/notifications') ? 'bg-[#4a5439]' : 'hover:bg-[#4a5439]'
                }`}
            >
              <div className="flex gap-[8px] items-center">
                <div className="relative w-[20px] h-[20px]">
                  <Image
                    ...
                    width={isCollapsed ? 28 : 16}
                    height={isCollapsed ? 28 : 16}
                    className={`opacity-80 group-hover:opacity-0 absolute transition-opacity ${isActive('/admin/dashboard/notifications') ? 'opacity-0' : ''
                      }`}
                  />
                  <Image
                    ...
                    className={`opacity-0 ml-[1px] mt-[1px] group-hover:opacity-100 absolute transition-opacity ${isActive('/admin/dashboard/notifications') ? 'opacity-100' : ''
                      }`}
                  />
                </div>
                <p
                  className={`font-normal text-[16px] leading-[20px] ${isActive('/admin/admin/dashboard/notifications')
                    ? 'text-[#eefb75]'
          ...
          <div className="flex-1 ml-[-14px]">
            ...
            <Link onClick={() => { setIsMobileOpen(false) }}
              ...
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive('/admin/dashboard')
                ? 'bg-[#4a5439]'
                : 'hover:bg-[#4a5439]'
                }`}
            >
              <div className="relative w-[20px] h-[20px]">
                <Image
                  ...
                  width={isCollapsed ? 28 : 16}
                  height={isCollapsed ? 28 : 16}
                  className={`opacity-100 group-hover:opacity-0 ml-[2px] mt-[2px] absolute transition-opacity ${isActive('/admin/dashboard') ? 'hidden' : ''
                    }`}
                />
                <Image
                  src="/images/home.png"
                  ...
                  className={`opacity-0 group-hover:opacity-100 absolute transition-opacity ${isActive('/admin/dashboard') ? 'opacity-100' : ''
                    }`}
                />
              </div>
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive('/admin/dashboard')
                  ? 'text-[#eefb75]'
                  : 'text-[#ffffff] group-hover:text-[#eefb75]'
                  } ${isCollapsed ? 'hidden' : 'block'}`}
              >
            ...
            <Link onClick={() => { setIsMobileOpen(false) }}
              ...
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive('/admin/dashboard/application') || isActive('/admin/dashboard/application/detail/[id]')
            ...
            >
              <div className="relative w-[20px] h-[20px]">
                <Image
                  ...
                  className={`opacity-100 group-hover:opacity-0 absolute transition-opacity ${isActive('/admin/dashboard/application') ? 'opacity-0' : ''
                    }`}
                />
                <Image
                  ...
                  width={isCollapsed ? 28 : 20}
                  height={isCollapsed ? 28 : 20}
                  className={`opacity-0 group-hover:opacity-100 absolute transition-opacity ${isActive('/admin/dashboard/application') ? 'opacity-100' : ''
                    }`}
                />
              </div>
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive('/admin/dashboard/application')
                  ? 'text-[#eefb75]'
                  : 'text-[#ffffff] group-hover:text-[#eefb75]'
                  } ${isCollapsed ? 'hidden' : 'block'}`}
              >
            ...
            <Link onClick={() => { setIsMobileOpen(false) }}
              ...
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive('/admin/dashboard/certificates')
                  ? 'bg-[#4a5439]'
                  : 'hover:bg-[#4a5439]'
                }`}
            >
              <div className="relative w-[20px] h-[20px]">
                <Image
                  ...
                  width={isCollapsed ? 28 : 20}
                  height={isCollapsed ? 28 : 20}
                  className={`opacity-100 group-hover:opacity-0 absolute transition-opacity ${isActive('/admin/dashboard/certificates') ? 'opacity-0' : ''
                    }`}
                />
                <Image
                  ...
                  width={isCollapsed ? 28 : 20}
                  height={isCollapsed ? 28 : 20}
                  className={`opacity-0 group-hover:opacity-100 absolute transition-opacity ${isActive('/admin/dashboard/certificates') ? 'opacity-100' : ''
                    }`}
                />
              </div>
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive('/admin/dashboard/certificates')
                  ? 'text-[#eefb75]'
                  : 'text-[#ffffff] group-hover:text-[#eefb75]'
                  } ${isCollapsed ? 'hidden' : 'block'}`}
              >
          ...
          <div className="pb-[24px] ml-[-14px]">
            ...
            <Link onClick={() => { setIsMobileOpen(false) }}
              ...
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 mb-[16px] ${isActive('/admin/dashboard/settings')
                ? 'bg-[#4a5439]'
                : 'hover:bg-[#4a5439]'
                }`}
            >
              ...
              />
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive('/admin/dashboard/settings')
                  ? 'text-[#eefb75]'
                  : 'text-[#ffffff] group-hover:text-[#eefb75]'
                  } ${isCollapsed ? 'hidden' : 'block'}`}
              >
            ...
            <div
              ...
              className={`flex gap-[8px] items-center px-[12px] py-[8px] rounded-[6px] cursor-pointer group transition-all duration-200 ${isActive("/admin/dashboard/help")
                ? "bg-[#4a5439]"
                : "hover:bg-[#4a5439]"
                }`}
            >
              <div className="relative w-[20px] h-[20px]">
                <Image
                  ...
                  width={isCollapsed ? 28 : 20}
                  height={isCollapsed ? 28 : 20}
                  className={`opacity-100 group-hover:opacity-0 absolute transition-opacity ${isActive("/admin/dashboard/help") ? "opacity-0" : ""
                    }`}
                />
                <Image
                  ...
                  width={isCollapsed ? 28 : 20}
                  height={isCollapsed ? 28 : 20}
                  className={`opacity-0 group-hover:opacity-100 absolute transition-opacity ${isActive("/admin/dashboard/help") ? "opacity-100" : ""
                    }`}
                />
              </div>
              <p
                className={`font-normal text-[16px] leading-[20px] ${isActive("/admin/dashboard/help")
                  ? "text-[#eefb75]"
                  : "text-[#ffffff] group-hover:text-[#eefb75]"
                  } ${isCollapsed ? "hidden" : "block"}`}
              >

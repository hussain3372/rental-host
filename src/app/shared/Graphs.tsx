...
//     | string
//     | string[]
//     | ((context: { chart: any }) => CanvasGradient | string);
//     borderColor?: string;
//     fill?: boolean;
//     tension?: number;
//     pointRadius?: number;
...
// const defaultTooltip = function (context: any) {
...
//           const color = tooltip.labelColors[i]?.backgroundColor || tooltip.labelColors[i]?.borderColor;
...
// const percentageTooltip = function (context: any) {
//   const { chart, tooltip } = context;
//   let tooltipEl = document.getElementById(`chartjs-custom-tooltip-${chart.id}`);
...
//     const currentIndex = labels.indexOf(titleLines[0]);
//     const total = totalValues[currentIndex];
...
//       const color = tooltip.labelColors[i]?.backgroundColor || tooltip.labelColors[i]?.borderColor;
//       const [label, valueStr] = body[0].split(":");
...
//               5000: "5k"
//             };
//             return allowedValues[num as keyof typeof allowedValues] || undefined;
//           }
...
//       tooltip: {
//         enabled: false,
//         external: function (context: { chart: Chart; tooltip: TooltipModel<ChartType> }) {
//           const { chart, tooltip } = context;
...
//         meta.data.forEach((bar: BarExtended, _index: number) => {
//           const x = bar.x;
//           const width = bar.width;

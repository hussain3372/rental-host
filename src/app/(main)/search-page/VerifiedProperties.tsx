...
const VerifiedProperties: React.FC<VerifiedPropertiesProps> = ({ properties }) => {
                ...
                <>
                    ...
                    <div className="grid gap-x-10 gap-y-[80px] sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-[80px]">
                        {displayedProperties.map((property) => (
                            <Link href={`/property-detail/${property.id}`} key={property.id}>
                                <div className="flex flex-col cursor-pointer">
                                    ...
                                    <div className="flex flex-col max-w-[373px]">
                                        <div className="flex items-center justify-between mt-5">
                                            <h3 className="text-[24px] leading-7 font-medium">{property.title}</h3>
                                            <StatusPill

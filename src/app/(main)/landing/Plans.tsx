      ...
      <div className=''>
        <BlackButton
          ...
          <div className='flex gap-[12px] items-center pt-[67px]'>
            <p className='text-white font-medium text-[12px] sm:text-[16px] leading-[22px] sm:leading-[24px]'>Monthly</p>
            <ToggleSwitch
            isOn={isOn}
            onToggle={setIsOn}/>
            <p className='text-[#999999] text-[12px] sm:text-[16px] leading-[22px] sm:leading-[24px]'>Yearly</p>

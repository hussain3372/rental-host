...
export default function Unlock() {
  return (
    <div className='max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-[120px] pb-[20px] sm:pb-[80px] pt-[78px]'>
      <div className='bg-[#EFFC76] pr-3 rounded-3xl  mx-auto text-black flex flex-col lg:flex-row justify-between items-center md:items-start overflow-hidden '>
        
        {/* Content Section */}
        <div className='p-8  sm:p-12 md:p-16 lg:p-[44px] flex-1'>
          <h3 className="font-medium text-2xl sm:text-3xl md:text-4xl lg:text-[48px] leading-tight lg:leading-[56px] max-w-[534px]">
            Ready to unlock the power of certifications?
          </h3>
